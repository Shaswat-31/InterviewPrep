...
function InterviewList() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-10">
      <h2 className="font-bold text-3xl text-blue-600 mb-4 animate-pulse">Previous Mock Interviews</h2>
      <div className="w-full max-w-4xl flex flex-col items-center bg-white p-6 rounded-lg shadow-lg">
        {interviewList ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-3 w-full">
